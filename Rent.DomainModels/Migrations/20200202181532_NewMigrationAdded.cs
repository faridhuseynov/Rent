        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LendPrice = table.Column<decimal>(nullable: false),
                    MinLendDays = table.Column<int>(nullable: false),
                    ProductDescription = table.Column<string>(nullable: true),
                    UserId = table.Column<string>(nullable: true),
                    CategoryId = table.Column<int>(nullable: false),
                    MainPhotoUrl = table.Column<string>(nullable: true),
                    Sell = table.Column<bool>(nullable: false),
                    Lend = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(nullable: false),
                    ProposedPrice = table.Column<decimal>(nullable: false),
                    OwnerId = table.Column<string>(nullable: true),
                    BuyerId = table.Column<string>(nullable: true),
                    ProposalStatusId = table.Column<int>(nullable: false),
                    ProposalTypeId = table.Column<int>(nullable: false),
                    ProposalAdded = table.Column<DateTime>(nullable: false),
                    ProposalClosed = table.Column<DateTime>(nullable: false),
                    ProposedRentStartDate = table.Column<DateTime>(nullable: false),
                    ProposedRentEndDate = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Proposals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Proposals_AspNetUsers_BuyerId",
                        column: x => x.BuyerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
